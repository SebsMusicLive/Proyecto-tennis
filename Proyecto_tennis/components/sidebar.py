...
def sidebar_footer() -> rx.Component:
    ...
    return rx.hstack(
        ...
        rx.spacer(),
        rx.color_mode.button(style={"opacity": "0.8", "scale": "0.85"}),
        justify="start",
        align="center",
        width="100%",
        padding="0.35em",
...
def sidebar_item(text: str, url: str) -> rx.Component:
    ...
    return rx.link(
        rx.hstack(
            rx.match(
                text,
                ("Estadisticas", sidebar_item_icon("trending-up")),
                ("Posiciones", sidebar_item_icon("move-vertical")),
                ("Configuracion", sidebar_item_icon("settings")),
